...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          if (authService.isEmailVerified) ...[
            ...
            const SizedBox(height: 20),
            _buildTextField(_emailController, localizations.translate('settings_label_email'), theme: theme),
            if (_codeSent)
              Padding(
                padding: const EdgeInsets.only(top: 16.0),
                child: _buildTextField(_codeController, localizations.translate('settings_label_code'), theme: theme),
              ),
            const SizedBox(height: 20),
            Center(
              child: ElevatedButton(
    ...
    return _CustomCard(
        ...
        child: Column(
            ...
            children: [
                ...
                const SizedBox(height: 16),
                _buildTextField(_helpMessageController, "Mensaje", theme: theme, maxLines: 4),
                const SizedBox(height: 20),
                Center(
                    child: ElevatedButton(
  ...
  Widget _buildThemeSection(AppLocalizations localizations, ThemeData theme) {
    ...
    return _CustomCard(
      ...
      child: SwitchListTile(
        title: Text(localizations.translate('settings_label_dark_mode'), style: TextStyle(color: isDarkMode ? Colors.white : Colors.black)),
    ...
    return _CustomCard(
      ...
      child: DropdownButtonFormField<Locale>(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.language, color: isDarkMode ? Colors.white70 : Colors.black54),
  ...
  Widget _buildTextField(TextEditingController controller, String label, {required ThemeData theme, int maxLines = 1}) {
    final isDarkMode = theme.brightness == Brightness.dark;
